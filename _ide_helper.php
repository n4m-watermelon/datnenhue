 ...
 * Generated for Laravel 5.8.36 on 2020-01-21 05:38:33.
 *
...
namespace App\Facades { 
    ...
    class MailVariableFacade {
        ...
        {
                        /** @var \App\Supports\MailVariable $instance */
    ...
    class AclManagerFacade {
        ...
        {
                        /** @var \App\Models\AclManager $instance */
    ...
    class AuditLogFacade {
         ...
         * @static 
         */ 
        public static function handleEvent($module, $data, $action, $type = 'info')
        {
                        /** @var \App\Models\AuditLog $instance */
                        return $instance->handleEvent($module, $data, $action, $type);
        }
         ...
         *
         * @param string $module
         * @param \stdClass|\App\Models\User|\Eloquent $data
         * @return string 
         * @static 
         */ 
        public static function getReferenceName($module, $data)
        {
                        /** @var \App\Models\AuditLog $instance */
                        return $instance->getReferenceName($module, $data);
        }
...
namespace  { 
    ...
    class MailVariable extends \App\Facades\MailVariableFacade {}
    ...
    class AclManager extends \App\Facades\AclManagerFacade {}

    class AuditLog extends \App\Facades\AuditLogFacade {}
